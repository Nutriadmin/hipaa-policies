...
* *Application*: An application hosted by NutriAdmin, either maintained and created by NutriAdmin, or maintained and created by a Partner.
...
* *Customers*: Contractually bound users of the NutriAdmin Platform.
...
* *Event*: An event is defined as an occurrence that does not constitute a serious adverse effect on NutriAdmin, its operations, or its Customers, though it may be less than optimal. Examples of events include, but are not limited to:
...
* *Organization*: For the purposes of this policy, the term "organization" shall mean NutriAdmin, or Magosoft Ltd, the registered company that owns and operates NutriAdmin.

* *Partner*: Contractual bound 3rd party vendor with integration with the NutriAdmin Platform.

* *Platform*: The overall technical environment of NutriAdmin.
...
* *Risk Management Team*: Individuals who are knowledgeable about the Organization's HIPAA Privacy, and Security policies, procedures, training program, computer system set up, and technical security controls, and who are responsible for the risk management process and procedures outlined below.
...
* *Security Incident* (or just Incident): A security incident is an occurrence that exercises a significant adverse effect on people, process, technology, or data. Security incidents include, but are not limited to:
  ...
  * Unauthorized change or destruction of ePHI (i.e. delete dictation, data alterations not following NutriAdmin's procedures);
