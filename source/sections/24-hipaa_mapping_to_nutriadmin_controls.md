# 24. HIPAA Mappings to NutriAdmin Controls

Below is a list of HIPAA Safeguards and Requirements and the NutriAdmin controls in place to meet those.

| **Administrative Controls** HIPAA Rule | NutriAdmin Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | NutriAdmin Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | NutriAdmin Control
---------------- | ----------------
